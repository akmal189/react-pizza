export default function Footer() {
    return(
        <footer className="border-t border-gray-200 sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
            <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
                &copy; 2019-2025 FastFood Shop. All rights reserved.
            </p>
